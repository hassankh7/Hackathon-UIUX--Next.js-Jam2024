...
import Logosofa2 from "@/app/assets/Logo Sofa.png"
...
const Footer =() => {
    ...
    <div className="container px-5 py-24 mx-auto flex justify-between">
      <div className="flex justify-between flex-wrap md:text-left text-center order-first">
        ...
        <Image src={Logosofa2} alt= "logo-sofa"/>
        ...
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav className="list-none mb-10">
            ...
            <li>
              <a className="text-gray-600 hover:text-gray-800">Wiring Chair</a>
            </li>
            <li>
          ...
          <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
            <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
              ...
              <input
                ...
                id="footer-field"
                name="footer-field"
                className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-[#029FAE] text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
            <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-[#029FAE] border-0 py-2 px-6 focus:outline-none hover:bg-green-300 rounded">
              Subscribe
            </button>
          </div>
      ...
      <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          <svg
            ...
            strokeWidth={2}
            className="w-10 h-10 text-white p-2 bg-[#029FAE] rounded-full"
            viewBox="0 0 24 24"
          >
        ...
        <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">
          © Design And Create 2020 Zakirsoft—
          <a
